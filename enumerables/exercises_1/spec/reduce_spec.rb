RSpec.describe 'reduce' do
  ...
  it 'capitalize key words in phrase' do
    ...
    # Your code goes here
    result = phrase.split.reduce do |sentence, word|
      sentence += " #{keywords.include?(word) ? word.upcase : word}"
    end
  ...
  it 'divides 560 by a bunch of numbers' do
    ...
    # Your code goes here
    result = numbers.reduce (560) do |acc, number|
      acc /= number
    end
  ...
  it 'adds all second values together' do
    ...
    # initial value is 0
    # Your code goes here
    result = elements.reduce(0) { |acc, element| acc += element.last }
