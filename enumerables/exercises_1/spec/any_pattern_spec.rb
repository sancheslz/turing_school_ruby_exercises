RSpec.describe 'Any Pattern Test' do
  ...
  it 'has a multi word phrase' do
    ...
    phrases.each { |phrase| has_multi_word_phrase = true if phrase.split.size > 1}
  ...
  it 'has no monkeys' do
    ...
    # Your code goes here
    has_monkeys = false
    animals.each { |animal| has_monkeys = animal == 'monkey'}
  ...
  it 'has no multiples of five' do
    ...
    numbers.each { |number| multiples_of_5 = number % 5 == 0}
