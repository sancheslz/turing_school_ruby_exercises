RSpec.describe 'select' do
  ...
  it 'floats' do
    ...
    # Your code goes here
    floats = numbers.select { |number| number.instance_of?(Float) }
  ...
  it 'arrays' do
    ...
    # Your code goes here
    arrays = elements.select { |element| element.instance_of?(Array) }
  ...
  it 'hashes' do
    ...
    # Your code goes here
    hashes = elements.select { |element| element.instance_of?(Hash) }
