RSpec.describe 'none' do
  ...
  it 'none shall pass' do
    ...
    # Your code goes here
    none_shall_pass = critters.none? { |critter| critter.equal?('shall pass') }
  ...
  it 'one or more shall pass' do
    ...
    # Your code goes here
    none_shall_pass = phrases.none? { |phrase| !phrase.equal?('shall pass') }
  ...
  it 'none even' do
    ...
    # Your code goes here
    none_even = numbers.none? { |number| number % 2 == 0 }
